...
ActiveRecord::Schema.define(version: 2022_06_10_142730) do
  ...
  create_table "timecards", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["employee_id"], name: "index_timecards_on_employee_id"
    t.index ["start_id"], name: "index_timecards_on_start_id"
    t.index ["stop_id"], name: "index_timecards_on_stop_id"
  end
